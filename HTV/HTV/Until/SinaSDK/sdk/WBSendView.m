...
{
    if (self = [super initWithFrame:CGRectMake(0, 0, MainViewWidth, MainViewHeight)])
    {
        ...
        [panelImageView setImage:[[UIImage imageNamed:@"weibobg.png"] stretchableImageWithLeftCapWidth:18 topCapHeight:18]];
        ...
        {
            [titleLabel setText:NSLocalizedString(@"Sina", nil)];
        }
...
- (void)onSendButtonTouched:(id)sender
{
    if ([contentTextView.text isEqualToString:@""])
    {
        ...
        {
            UIAlertView * alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Sina microblogging", nil)
                                                                 message:NSLocalizedString(@"Please enter microblogging content", nil)
                                                                delegate:nil
    ...
    if (GetCurrentLanguage==1) {
        [self addHUDActivityView:@"发送中..."];
    }
    else
    {
        [self addHUDActivityView:@"sending..."];
    }
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    {
        [self setFrame:CGRectMake(0, 0, MainViewHeight, MainViewWidth)];
        [panelView setFrame:CGRectMake(16, 10, MainViewHeight - 32, 280)];
        [contentTextView setFrame:CGRectMake(13, 50, MainViewHeight - 32 - 26, 60 + 50)];
        ...
        [panelImageView setFrame:CGRectMake(0, 0, MainViewHeight - 32, 280)];
        [panelImageView setImage:[UIImage imageNamed:@"weibobg_land.png"]];
        [sendButton setFrame:CGRectMake(MainViewHeight- 32 - 15 - 48, 13, 48, 30)];
        [titleLabel setCenter:CGPointMake(448 / 2, 27)];
    
        if (isKeyboardShowing)
        {
            [contentTextView setFrame:CGRectMake(13, 50, MainViewHeight - 32 - 26, 60)];
