...
- (void)engine:(WBEngine *)engine requestDidFailWithError:(NSError *)error request:(WBRequest*)requestObj;
- (void)engine:(WBEngine *)engine requestDidSucceedWithResult:(id)result request:(WBRequest*)requestObj;
@end
...
// @postDataType: "GET" for kSinaWBRequestPostDataTypeNone, "POST" for kSinaWBRequestPostDataTypeNormal or kSinaWBRequestPostDataTypeMultipart.
