...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, MainViewWidth, MainViewHeight)])
    {
        ...
        // add the panel view
        panelView = [[UIView alloc] initWithFrame:CGRectMake(0, 30, MainViewWidth, 430)];
        ...
        containerView = [[UIView alloc] initWithFrame:CGRectMake(5, 5, panelView.frame.size.width-5*2, panelView.frame.size.height-5*2)];
        ...
        // add the web view
        webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, containerView.frame.size.width, containerView.frame.size.height)];
        ...
        [closeAuthBtn setFrame:CGRectMake(0, 0, 24, 24)];
        closeAuthBtn.center=CGPointMake(12, 12);
        [closeAuthBtn setBackgroundImage:GETIMG(@"close@2x.png") forState:UIControlStateNormal];
        [closeAuthBtn addTarget:self action:@selector(onCloseButtonTouched:) forControlEvents:UIControlEventTouchUpInside];
        [panelView addSubview:closeAuthBtn];
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    if (UIInterfaceOrientationIsLandscape(orientation))
    {
        ...
        [panelView setFrame:CGRectMake(10, 30, MainViewHeight, 280)];
