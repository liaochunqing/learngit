...
- (NSMutableData *)postBody
{
    ...
    if (postDataType == kSinaWBRequestPostDataTypeNormal)
    {
        [WBRequest appendUTF8Body:body dataString:[WBRequest stringFromDictionary:params]];
    }
    else if (postDataType == kSinaWBRequestPostDataTypeMultipart)
    {
...
- (void)connect
{
    ...
    {
        if (postDataType == kSinaWBRequestPostDataTypeMultipart)
        {
